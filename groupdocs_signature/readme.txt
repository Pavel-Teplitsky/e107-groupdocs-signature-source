=== GroupDocs Word,Excel,Powerpoint,PDF signature ===
...
Lets you embed the GroupDocs Word, Excel, Powerpoint, PDF signature into Wordpress for your documents.

== Description ==

GroupDocs Word, Excel, Powerpoint, PDF signature Embedder lets you embed several types of files into your WordPress pages using the GroupDocs High Fidelity signature - allowing inline viewing (and optional downloading) of the following file types, with no Flash or PDF browser plug-ins required: 
...
There are several benefits to using an [online document signature](http://groupdocs.com/apps/signature/ "Online document signature"),such as the [GroupDocs signature](http://groupdocs.com/apps/signature/). The main one is that it is platform and software independent. No matter  what type of computer or software you have, you can view most common business file formats. You don't have to install software or go through complicated conversion processes. Just upload the file and look at the content in your browser.

GroupDocs signature can be used as a [Microsoft Word signature](http://groupdocs.com/apps/signature/) (A Word signature is a program that lets you read Microsoft Word documents). People who don't have the most recent version of Microsoft Office, or who don't have Office at all, can still view Word DOCX files through GroupDocs signature. There no need to convert the document, or install a special extension. The same applies to PDF files: GroupDocs signature is a Word signature and a PDF reader all in one.

GroupDocs signature helps you find what you are looking for. It has an inbuilt search function so that you can find specific words of phrases quickly. Navigation is easy: navigate using thumbnails or go to a specific page. GroupDocs signature also lets you print the document, or download it to your computer, so that you can read it offline.

= Embedding Documents on Your Website =
GroupDocs signature lets you embed a document on your website so that anyone who visits can read it with GroupDocs signature. You embed the document with our online document signature. Just like you can view any document on GroupDocs, any of your website visitors can read your documents on your website. They don't need the software that the document was created in, they don't need to download and install software. They just click and read.

The GroupDocs signature online document signature is easy to use and looks professional. It is as easy to embed as a YouTube film or Vimeo video. Just copy, paste, publish and go.

[View PDF, DOC, DOCX, PPT, PPTX, XLS](http://groupdocs.com/apps/signature/) and many other documents in your browser without installing software.
If you have Microsoft Word 2003 (DOC), youll find it difficult to view Microsoft Word 2010 documents (DOCX). Although the compressed file format (DOCX) has been around for a while, not everyone can read it. You can overcome this hurdle if you use GroupDocs signature as its a perfect Word signature. The same is true for a lot of other formats. GroupDocs signature overcomes that problem by taking documents in all kinds of formats and showing them on screen. You don't need to have the program that created a document to read it. This means that you can share documents without worrying about what programs your colleagues have. Through GroupDocs signature, you can view almost any document and see it the way it was meant to look.
...
Upload the documents to your GroupDocs account. Use the GroupDocs signature Embedder button in the Visual editor to build the appropriate shortcode by copy&pasting the document groupdocs.com link.
...
1. Here's a screenshot of how to get your document link for insertion into the GroupDocs signature Embedder dialog
2. Here's a screenshot of the GroupDocs signature Embedder in a Wordpress blog
